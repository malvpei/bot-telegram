    ...
    def _social_copy_variants_es(
        ...
        if video_type == VideoType.TYPE_4:
            return {
                ...
                "es_story_11": (
                    "De servir pedidos a construir mi propia historia",
                    (
                        "El comienzo no tuvo nada de espectacular: turnos en McDonald's, "
                        "noches frente al portátil y una tienda que seguía marcando cero "
                        "ventas. Montarla me llevó horas, pero elegir productos sin un "
                        "criterio claro me costó todavía más. Después de tres intentos "
                        "fallidos entendí que insistir no bastaba si repetía el mismo "
                        "proceso. Empecé a validar demanda, competencia y creativos con "
                        "Dropradar antes de lanzar. La primera venta fue pequeña, pero "
                        "confirmó que por fin estaba construyendo sobre datos y no solo "
                        "sobre ganas. El resultado final llegó mucho después, como "
                        "consecuencia de repetir y mejorar ese método."
                    ),
                    [
                        "#dropshipping",
                        "#historiasreales",
                ...
                "es_story_12": (
                    "El primer mes en cero no fue el final",
                    (
                        "Ver cero ventas después de montar la tienda hizo que todo el "
                        "trabajo anterior pareciera inútil. El producto no despertaba "
                        "interés y mi primera reacción fue cambiar anuncios, textos y "
                        "diseños sin saber qué problema estaba intentando resolver. Los "
                        "meses siguientes probé tres productos más y estuve cerca de "
                        "abandonar. El cambio llegó cuando dejé de lanzar primero y "
                        "preguntar después. Con Dropradar empecé a revisar señales reales "
                        "antes de invertir, encontré una oportunidad con mejores "
                        "argumentos y conseguí la primera venta. Aquel cero no definía el "
                        "resultado; solo mostraba que el proceso necesitaba cambiar."
                    ),
                    [
                        "#dropshipping",
                        "#primeraventa",
                ...
                "es_story_13": (
                    "Tres productos fallaron antes de acertar",
                    (
                        "Los tres primeros productos no vendieron y cada intento hizo más "
                        "difícil confiar en el siguiente. Durante un tiempo pensé que la "
                        "respuesta era trabajar más horas, cuando en realidad necesitaba "
                        "tomar mejores decisiones antes de montar otra oferta. Revisar "
                        "demanda, saturación y creativos con Dropradar me permitió descartar "
                        "ideas débiles sin convertirlas en campañas completas. El producto "
                        "que trajo la primera venta no apareció por suerte: pasó un filtro "
                        "que los anteriores nunca habían tenido. Un año y medio después, "
                        "la diferencia no era haber dejado de fallar, sino saber qué "
                        "aprender y cómo elegir el siguiente paso."
                    ),
                    [
                        "#dropshipping",
                        "#productosganadores",
                ...
                "es_story_14": (
                    "La primera venta empezó con una mejor pregunta",
                    (
                        "Antes preguntaba qué producto parecía más viral. Después de meses "
                        "sin ventas empecé a preguntar algo distinto: qué señales indicaban "
                        "que existía demanda y que todavía había espacio para competir. Esa "
                        "pregunta cambió el orden de todo. Primero investigaba con "
                        "Dropradar, después comparaba productos y solo entonces construía "
                        "la tienda y los creativos. La primera venta llegó ese mes, pero lo "
                        "importante fue entender por qué aquella prueba tenía más sentido "
                        "que las anteriores. El objetivo grande tardó un año y medio; la "
                        "transformación real empezó mucho antes, cuando cada lanzamiento "
                        "dejó de depender únicamente de una corazonada."
                    ),
                    [
                        "#dropshipping",
                        "#productvalidation",
                ...
                "es_story_15": (
                    "No fue el Porsche, fue aprender a validar",
                    (
                        "El Porsche 911 GT3 es la imagen que más llama la atención, pero "
                        "no explica la parte decisiva de esta historia. Antes hubo turnos "
                        "en McDonald's, una tienda sin pedidos, tres productos que no "
                        "funcionaron y muchas dudas sobre si continuar. El punto de giro no "
                        "fue comprar algo, sino aprender a validar antes de gastar. "
                        "Dropradar me ayudó a comparar datos de mercado y a elegir una "
                        "prueba con fundamentos suficientes para conseguir la primera "
                        "venta. Lo que vino después fue un año y medio de trabajo, ajustes "
                        "y constancia. El coche representa el final visible; el método fue "
                ...
                "es_story_16": (
                    "El cambio ocurrió antes de lanzar el anuncio",
                    (
                        "Creía que mis resultados dependían casi por completo del anuncio, "
                        "así que dedicaba horas a editar creativos para productos que nunca "
                        "había validado bien. El primer mes terminó sin ventas y los tres "
                        "productos siguientes tampoco funcionaron. Cuando estaba a punto de "
                        "dejarlo, moví el esfuerzo al principio del proceso: investigar "
                        "demanda, competencia y señales de venta. Con Dropradar pude "
                        "comparar oportunidades antes de construir la campaña. La primera "
                        "venta no demostró que todo estuviera resuelto, pero sí que una "
                        "mejor selección daba al anuncio una oportunidad real de funcionar "
                        "en lugar de pedirle que salvara una mala idea."
                    ),
                    [
                        "#dropshipping",
                        "#marketingdigital",
                ...
                "es_story_17": (
                    "Un año y medio resumido en siete imágenes",
                    (
                        "Siete imágenes pueden hacer que el camino parezca rápido: trabajo "
                        "en McDonald's, tienda nueva, cero ventas, tres productos fallidos, "
                        "Dropradar, primera venta y finalmente el Porsche. Entre cada una "
                        "hubo semanas de dudas, decisiones equivocadas y pruebas que nadie "
                        "vio. La parte que conectó la historia fue dejar de escoger productos "
                        "por apariencia y empezar a exigir datos antes de invertir. Aquella "
                        "primera venta no cambió mi vida de inmediato; cambió mi confianza "
                        "en el proceso. Durante el siguiente año y medio seguí aplicándolo, "
                        "midiendo y corrigiendo hasta convertir un resultado aislado en una "
                        "dirección que podía mantener."
                    ),
                    [
                        "#dropshipping",
                        "#ecommercejourney",
                ...
                "es_story_18": (
                    "Cuando dejé de perseguir productos virales",
                    (
                        "Cada producto viral parecía una nueva oportunidad y acababa "
                        "produciendo el mismo resultado: una tienda preparada deprisa, "
                        "anuncios sin respuesta y ninguna venta. Después del tercer fallo "
                        "entendí que llegar tarde a una tendencia no era una estrategia. "
                        "Empecé a usar Dropradar para estudiar demanda, competencia y "
                        "creativos antes de decidir. Eso no eliminó el riesgo, pero sí "
                        "eliminó muchas apuestas que no podían justificar el presupuesto. "
                        "La primera venta llegó con un producto elegido por sus señales y "
                        "no por el ruido que generaba. A partir de ahí el crecimiento fue "
                        "menos emocionante de contar, pero mucho más lógico de repetir."
                    ),
                    [
                        "#dropshipping",
                        "#productosvirales",
                        "#investigaciondeproducto",
                        "#shopify",
                        "#dropradar",
                    ],
                ),
                "es_story_19": (
                    "La constancia funcionó cuando tuvo dirección",
                    (
                        "Nunca faltaron horas de trabajo. Lo que faltaba era una dirección "
                        "clara para esas horas. Podía pasar la noche montando una tienda y "
                        "seguir igual de lejos de la primera venta si el producto se había "
                        "elegido sin datos. Tras varios meses y tres pruebas fallidas, "
                        "incorporé una fase de validación con Dropradar antes de crear la "
                        "oferta. Por primera vez sabía qué señales apoyaban la decisión y "
                        "qué tendría que observar al lanzar. La venta llegó, después llegó "
                        "el aprendizaje de repetir el proceso y, un año y medio más tarde, "
                        "el objetivo que parecía imposible. La constancia importó cuando "
                        "dejó de empujar en direcciones aleatorias."
                    ),
                    [
                        "#dropshipping",
                        "#disciplina",
                ...
                "es_story_20": (
                    "Lo que hay entre McDonald's y un 911 GT3",
                    (
                        "Entre el primer turno y la foto final no hubo un atajo. Hubo una "
                        "tienda construida con ilusión, un primer mes sin pedidos, tres "
                        "productos que no encontraron compradores y un momento en el que "
                        "dejarlo parecía razonable. También hubo una decisión que cambió el "
                        "proceso: validar con datos antes de invertir. Dropradar ayudó a "
                        "identificar una oportunidad con señales reales y aquella prueba "
                        "consiguió la primera venta. Después vinieron dieciocho meses de "
                        "repetir, aprender y ajustar. La distancia entre ambos puntos no se "
                        "explica con suerte ni con una sola herramienta, sino con mejores "
                        "decisiones mantenidas durante suficiente tiempo."
                    ),
                    [
                        "#dropshipping",
                        "#mcdonalds",
    ...
    def _social_copy_variants_en(
        ...
        if video_type == VideoType.TYPE_4:
            return {
                ...
                "en_story_11": (
                    "From serving orders to building my own story",
                    (
                        "The beginning was not glamorous: shifts at McDonald's, late nights "
                        "on a laptop and a store that still showed zero sales. Building the "
                        "site took hours, but choosing products without clear criteria cost "
                        "even more. After three failed attempts, I realized persistence was "
                        "not enough if I kept repeating the same process. I began checking "
                        "demand, competition and creative signals with Dropradar before each "
                        "launch. The first sale was small, but it proved I was finally "
                        "building on evidence rather than motivation alone. The visible "
                        "result came much later, after repeating and improving that method."
                    ),
                    ["#dropshipping", "#realstory", "#ecommerce", "#consistency", "#dropradar"],
                ),
                "en_story_12": (
                    "Zero sales in month one was not the ending",
                    (
                        "Seeing zero sales after building the store made every hour of work "
                        "feel wasted. The product attracted no real interest, so I reacted "
                        "by changing ads, copy and design without knowing which problem I "
                        "was solving. Three more products failed and quitting started to "
                        "feel reasonable. The shift came when I stopped launching first and "
                        "asking questions later. Dropradar helped me review real market "
                        "signals before spending, and the next opportunity had stronger "
                        "reasons behind it. That first sale did not erase the difficult "
                        "months, but it showed that zero was feedback about the process, not "
                        "a final verdict on the goal."
                    ),
                    ["#dropshipping", "#firstsale", "#onlinestore", "#productresearch", "#dropradar"],
                ),
                "en_story_13": (
                    "Three products failed before one made sense",
                    (
                        "The first three products did not sell, and every failed launch made "
                        "it harder to trust the next one. I thought the answer was more "
                        "hours, when what I needed was a better decision before building "
                        "another offer. Comparing demand, saturation and active creatives "
                        "through Dropradar let me reject weak ideas before turning them into "
                        "full campaigns. The product that produced the first sale was not a "
                        "lucky guess; it had passed a filter the others never faced. A year "
                        "and a half later, the biggest difference was not that failure had "
                        "disappeared. It was knowing what each test meant and how to choose "
                        "the next one with more discipline."
                    ),
                    ["#dropshipping", "#winningproducts", "#ecommercetips", "#learning", "#dropradar"],
                ),
                "en_story_14": (
                    "The first sale began with a better question",
                    (
                        "I used to ask which product looked most viral. After months without "
                        "sales, I started asking which signals showed real demand and enough "
                        "room to compete. That question changed the order of everything. I "
                        "researched with Dropradar first, compared opportunities second and "
                        "only then built the store and creatives. The first sale arrived "
                        "that month, but the useful part was understanding why this test had "
                        "more logic than the previous ones. The larger goal took another "
                        "year and a half. The real transformation began much earlier, when "
                        "launches stopped depending entirely on a feeling and started with "
                        "a reason I could explain."
                    ),
                    ["#dropshipping", "#productvalidation", "#ecommercebusiness", "#firstorder", "#dropradar"],
                ),
                "en_story_15": (
                    "It was not the Porsche, it was learning to validate",
                    (
                        "The Porsche 911 GT3 is the image that gets attention, but it is not "
                        "the decisive part of this story. Before it came restaurant shifts, "
                        "a store with no orders, three products that failed and serious "
                        "doubts about continuing. The turning point was not buying something; "
                        "it was learning to validate before spending. Dropradar helped me "
                        "compare market evidence and choose a test with enough foundation "
                        "to earn the first sale. What followed was eighteen months of work, "
                        "adjustments and consistency. The car represents the visible ending, "
                        "while the repeatable method explains how the story kept moving."
                    ),
                    ["#dropshipping", "#porsche911gt3", "#entrepreneur", "#productresearch", "#dropradar"],
                ),
                "en_story_16": (
                    "The real change happened before the ad launched",
                    (
                        "I believed results depended almost entirely on the ad, so I spent "
                        "hours editing creatives for products I had never properly "
                        "validated. Month one ended with no sales, and the next three "
                        "products failed too. When I was close to quitting, I moved the "
                        "effort to the start of the process: demand, competition and sales "
                        "signals. Dropradar gave me a way to compare opportunities before "
                        "building the campaign. The first sale did not prove everything was "
                        "solved, but it proved that stronger product selection gave the ad "
                        "a fair chance instead of asking a creative to rescue a weak idea."
                    ),
                    ["#dropshipping", "#digitalmarketing", "#creatives", "#ecommerce", "#dropradar"],
                ),
                "en_story_17": (
                    "A year and a half compressed into seven images",
                    (
                        "Seven images can make the journey look quick: McDonald's shifts, a "
                        "new store, zero sales, three failed products, Dropradar, the first "
                        "sale and finally the Porsche. Between them were weeks of doubt, "
                        "wrong decisions and tests nobody saw. What connected the story was "
                        "stopping the habit of picking products by appearance and requiring "
                        "evidence before investing. That first sale did not change my life "
                        "overnight; it changed my confidence in the process. For the next "
                        "eighteen months I kept applying, measuring and correcting it until "
                        "one isolated result became a direction I could maintain."
                    ),
                    ["#dropshipping", "#ecommercejourney", "#successstory", "#consistency", "#dropradar"],
                ),
                "en_story_18": (
                    "What changed when I stopped chasing viral products",
                    (
                        "Every viral product looked like a fresh opportunity and produced "
                        "the same outcome: a rushed store, ads with no response and no "
                        "sales. After the third failure, I understood that arriving late to "
                        "a trend was not a strategy. I started using Dropradar to examine "
                        "demand, competition and creative activity before choosing. That did "
                        "not remove risk, but it removed many bets that could not justify "
                        "the budget. The first sale came from a product selected for its "
                        "signals rather than its noise. Growth after that was less dramatic "
                        "to describe, but far more logical to repeat and improve."
                    ),
                    ["#dropshipping", "#viralproducts", "#productresearch", "#shopify", "#dropradar"],
                ),
                "en_story_19": (
                    "Consistency worked once it had direction",
                    (
                        "There was never a shortage of effort. What was missing was a clear "
                        "direction for that effort. I could spend all night building a store "
                        "and remain just as far from a sale if the product had been chosen "
                        "without evidence. After several months and three failed tests, I "
                        "added a validation stage with Dropradar before creating the offer. "
                        "For the first time, I knew which signals supported the decision and "
                        "what the launch was meant to test. The sale came, then the work of "
                        "repeating the process, and eighteen months later the goal that once "
                        "felt impossible. Persistence mattered after it stopped pushing in "
                        "random directions."
                    ),
                    ["#dropshipping", "#discipline", "#onlinebusiness", "#productvalidation", "#dropradar"],
                ),
                "en_story_20": (
                    "What sits between McDonald's and a 911 GT3",
                    (
                        "There was no shortcut between the first shift and the final photo. "
                        "There was a store built with excitement, a first month without "
                        "orders, three products that found no buyers and a moment when "
                        "quitting looked reasonable. There was also one decision that "
                        "changed the process: validating with data before investing. "
                        "Dropradar helped identify an opportunity with stronger market "
                        "signals, and that test produced the first sale. Then came eighteen "
                        "months of repeating, learning and adjusting. The distance between "
                        "those two points is not explained by luck or one tool, but by "
                        "better decisions kept in place for long enough to compound."
                    ),
                    ["#dropshipping", "#mcdonalds", "#porsche911", "#ecommerce", "#dropradar"],
                ),
            }
        if video_type == VideoType.TYPE_1:
            return {
